...
const LOGO_HORIZONTAL = { src: "/images/logo-horizontal.png", width: 2624, height: 958 };
const LOGO_MARK = { src: "/images/logo-mark.png", width: 1688, height: 2551 };

/** Símbolo oficial enorme ao fundo. A caixa recorta a faixa do texto
 *  "LA FACULDADES" do arquivo, deixando só o símbolo. */
function Watermark() {
  return (
          ...
          <article className="quiz-stack-card__inner vq-card vq-card--intro" aria-labelledby="vq-card-intro-titulo">
            ...
            <div className="vq-card__body">
              ...
              <p className="vq-card__text">
                Descubra os cursos da LA que mais combinam com seus interesses, habilidades e jeito de pensar.
              </p>
