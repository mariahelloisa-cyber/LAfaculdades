...
export default async function EnemPage() {
  ...
  return (
    <>
      ...
      {/* Quanto maior a nota, maior o desconto — faixa escura com o grafismo
      ...
      <section className="relative isolate overflow-hidden bg-tint-deep">
        ...
        >
          <BlobDepoimentos fill="#cbe0ee" manterProporcao />
        </div>
        ...
        <Container className="relative z-10 pt-10 lg:pt-14">
          <div className="mx-auto max-w-2xl text-center">
            <AnimatedText
              ...
              destaque={{ texto: "maior o desconto.", className: "text-accent" }}
            >
              Quanto maior a nota, maior o desconto.
            </AnimatedText>

            <AnimatedText as="p" delay={0.12} className="t-lead mx-auto mt-6 max-w-xl text-muted">
              O valor exato do seu desconto depende da sua nota e é calculado pela nossa equipe de
              matrículas — mas a regra é simples: nota mais alta, desconto maior na mensalidade.
            </AnimatedText>

            <AnimatedText as="div" delay={0.24} className="mt-10">
              <a
                href="#simulador"
                className="group inline-flex h-14 items-center justify-between gap-5 rounded-full bg-[#ffd600] pl-8 pr-3 text-base font-bold text-navy-950 transition-colors hover:bg-[#e6c200] sm:h-16"
              >
                Simule agora
      ...
      {/* Formulário */}
      <section id="simulador" className="section-y scroll-mt-[58px] bg-[#f7fafd] lg:scroll-mt-[64px]">
        <Container className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <Reveal>
            <div className="flex items-center gap-4">
              <span className="h-[3px] w-10 shrink-0 rounded-full bg-[#ffd600]" aria-hidden />
            ...
            <div className="mt-10 grid gap-7 sm:grid-cols-3 sm:gap-0">
              {destaques.map((d, i) => (
                ...
                >
                  <span className="flex h-11 w-11 items-center justify-center rounded-full bg-[#fff3bf] text-[#8a6d00]">
