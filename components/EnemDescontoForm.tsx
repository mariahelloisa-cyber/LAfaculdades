...
export default function EnemDescontoForm({
  ...
  if (enviado) {
    return (
      <div className="rounded-[28px] bg-navy-950 p-9 text-center shadow-[0_24px_60px_rgba(6,21,35,0.12)]">
  ...
  return (
    ...
    >
          ...
          return (
            <button
              ...
              className={`flex h-12 items-center justify-center gap-2.5 rounded-full text-[15px] font-bold transition-colors ${
                ativo
                  ? "bg-[#ffd600] text-navy-950 shadow-[0_4px_12px_rgba(6,21,35,0.12)]"
      ...
      {/* Nota do ENEM */}
      <div className="mt-4 rounded-2xl bg-[#f4f8fc] p-5">
