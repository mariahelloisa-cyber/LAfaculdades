    ...
    <div ref={rootRef} className="ed">
      ...
      <section className="ed-intro" aria-labelledby="ed-intro-titulo">
        ...
        <div className="ed-intro__foot">
          <p className="ed-label ed-intro__label"> Sobre a LA </p>
          <p className="ed-intro__text">
            A LA Faculdades é credenciada pelo MEC e nasceu para tornar o ensino superior acessível sem
            abrir mão da qualidade acadêmica.
          </p>
        </div>
      ...
      <section className="ed-works" aria-labelledby="ed-works-titulo">
        <div className="ed-grid">
          <h2 id="ed-works-titulo" className="ed-display ed-works__title">
            ...
            <span className="ed-line">inspira e transforma.</span>
          </h2>

          <article className="ed-block ed-block--a">
            <div className="ed-block__meta">
              <p className="ed-label ed-block__tag">
                <span>Graduação e Pós-Graduação</span>
        
              </p>
              <h3 className="ed-block__title">Educação acessível ao alcance de todos</h3>
              <p className="ed-block__text">
                Graduação e Pós-Graduação em modalidade EAD, pensados para quem
                já tem uma rotina cheia.
              </p>
            </div>
          ...
          <article className="ed-block ed-block--b">
            <div className="ed-block__meta">
              ...
              <h3 className="ed-block__title">Aqui você aprende de verdade.</h3>
              <p className="ed-block__text">
      ...
      <section className="ed-feature" aria-labelledby="ed-feature-titulo">
        <div className="ed-feature__inner">
          ...
          <p className="ed-feature__caption">
            {/* Adaptado da Missão (PDF de branding). */}
            Foco em tecnologias educacionais e referência em novos modelos de ensino, sem perder a
            essência de acessibilidade e inclusão.
          </p>
        </div>
      </section>
      ...
      <section className="ed-film" aria-labelledby="ed-film-titulo">
        <div className="ed-film__media">
          <video
            ...
            playsInline
            preload="metadata"
            aria-label="Vídeo institucional da LA Faculdades"
          />
